...
@BotCommand(command = "/pref_all")
public class PreferredAllCommand extends CallbackCommand {

    private final SessionManager sessionManager;
    private final ChatControlMenu chatControlMenu;

    public PreferredAllCommand(TelegramBot telegramBot,
    ...
    protected void handleCallbackQuery(Update update) {
        ...
        session.setPreferredGender("ALL");
        ...
        sendTextMessage(chatId,
                "✅ *Настройки завершены!*\n\n" +
                        ...
                        "Ищете: 👥 Всех (без разграничения по полу)\n\n" +
