...
@BotCommand(command = "/gender_female")
public class GenderFemaleCommand extends CallbackCommand {

    private final SessionManager sessionManager;
    private final ChatControlMenu chatControlMenu;

    public GenderFemaleCommand(TelegramBot telegramBot,
    ...
    protected void handleCallbackQuery(Update update) {
        processGenderSelection(update, "FEMALE", "👩 женский");
    }
