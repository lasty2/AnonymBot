...
@BotCommand(command = "/pref_female")
public class PreferredFemaleCommand extends CallbackCommand {

    private final SessionManager sessionManager;
    private final ChatControlMenu chatControlMenu;

    public PreferredFemaleCommand(TelegramBot telegramBot,
    ...
    protected void handleCallbackQuery(Update update) {
        ...
        session.setPreferredGender("FEMALE");
